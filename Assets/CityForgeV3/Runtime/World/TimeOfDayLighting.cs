    ...
    public static class TimeOfDayLighting
    {
        private static readonly TimeOfDayLightingSpec[] Specs =
        {
            new(
                ...
                new Color(0.3875f, 0.4375f, 0.5375f),
            ...
            new(
                ...
                new Color(0.4375f, 0.44375f, 0.475f),
            ...
            new(
                ...
                new Color(0.14f, 0.155f, 0.20f),
                new Color(0.13f, 0.16f, 0.145f),
                new Color(0.028f, 0.045f, 0.082f),
                new Color(0.08f, 0.15f, 0.34f, 0.12f),
                new Color(0.31f, 0.34f, 0.42f)),
            new(
