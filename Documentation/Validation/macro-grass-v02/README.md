...
The runtime texture is 4096 × 4096 RGB with no alpha. Opposite one-pixel borders compare at RMSE `0` horizontally and vertically. A 3 × 3 tiled preview was inspected after the localized edge blend and final 24% variation compression; V02 does not use V01's mirrored-quadrant construction.
